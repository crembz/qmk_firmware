 ...
 */
    [_BASE] = LAYOUT(
     ...
     KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,XXXXXXX,      XXXXXXX, KC_RBRC,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RCTRL,
 ...
 */
    [_NAV] = LAYOUT(
     ...
     XXXXXXX,  C(KC_Z), C(KC_Z), C(KC_C), C(KC_V), XXXXXXX, XXXXXXX,XXXXXXX,      XXXXXXX, XXXXXXX, KC_INS, KC_HOME, KC_PGDN, KC_PGUP, KC_END, XXXXXXX,
 ...
 */
    [_NUM] = LAYOUT(
      ...
      XXXXXXX, KC_GRV, KC_1, KC_2, KC_3, KC_BSLS, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                        KC_NUM, XXXXXXX, KC_DOT,   KC_0,  KC_MINS,   XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ),
